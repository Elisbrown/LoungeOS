...
const knowledgeBaseContent: KBCategory[] = [
  ...
  {
    titleKey: 'kb.kitchenBar.title',
    articles: [
        { titleKey: 'kb.kitchenBar.kds.title', contentKey: 'kb.kitchenBar.kds.content' },
        { titleKey: 'kb.kitchenBar.bds.title', contentKey: 'kb.kitchenBar.bds.content' },
        { titleKey: 'kb.kitchenBar.cancelOrder.title', contentKey: 'kb.kitchenBar.cancelOrder.content' },
    ]
  },
  {
